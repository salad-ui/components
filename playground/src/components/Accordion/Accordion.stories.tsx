  ...
  return (
    <>
      <Accordion expanded={expanded} onToggle={handleToggle}>
        <Accordion.Toggle rel="lorem-ipsum">
          Lorem Ipsum
        </Accordion.Toggle>
        <Accordion.Toggle rel="pirate-ipsum">
          Pirate Ipsum
        </Accordion.Toggle>
        ...
        <Accordion.Content rel="pirate-ipsum">
          <p>Jack Tar barkadeer lad salmagundi gibbet scuppers pressgang execution dock long boat warp. Reef sails take a caulk run a shot across the bow black spot transom driver pressgang carouser Pieces of Eight bilge rat. Haul wind gunwalls gangway lad smartly walk the plank deadlights hulk Nelsons folly Sea Legs.</p>
          <p>Main sheet no prey, no pay ballast execution dock reef hang the jib list brig handsomely yardarm. Provost sheet port Letter of Marque haul wind overhaul transom Pirate Round stern Sea Legs. Yawl coxswain Letter of Marque Jack Ketch sutler case shot Admiral of the Black killick lass measured fer yer chains.</p>
        </Accordion.Content>
      </Accordion>
    </>
  );
