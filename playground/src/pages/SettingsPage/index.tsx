            ...
            top={
              <DrawerMenu expanded={expanded} onToggle={handleToggle}>
                ...
                >
                  ...
                  <RouterDrawMenuLink to="/posts/write">
                    Add new
                  </RouterDrawMenuLink>
                  <RouterDrawMenuLink to="/posts/categories">
                    Categories
                  </RouterDrawMenuLink>
                  <RouterDrawMenuLink to="/posts/tags">Tags</RouterDrawMenuLink>
                </DrawerMenu.Group>
                <DrawerMenu.Group
                  before={<Image aria-hidden={true} />}
                  label="Media"
                >
                  <RouterDrawMenuLink to="/upload">Library</RouterDrawMenuLink>
                  <RouterDrawMenuLink to="/media/new">
                    Add new
                  </RouterDrawMenuLink>
                </DrawerMenu.Group>
                <DrawerMenu.Group
                  before={<Page aria-hidden={true} />}
                  label="Pages"
                ></DrawerMenu.Group>
                <DrawerMenu.Group
                ...
                ></DrawerMenu.Group>
                <DrawerMenu.Group
                  before={<Users aria-hidden={true} />}
                  label="Users"
                ></DrawerMenu.Group>
                <DrawerMenu.Group
                  before={<Wrench aria-hidden={true} />}
                  label="Tools"
                ></DrawerMenu.Group>
                <DrawerMenu.Group
                  before={<Cog aria-hidden={true} />}
                  label="Settings"
                ></DrawerMenu.Group>
              </DrawerMenu>
            }
